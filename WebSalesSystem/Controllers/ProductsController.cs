...
namespace WebSalesSystem.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(WebSalesSystemContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,Description,Price,ImageURL")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
